...
xx=[df[1992],df[1993],df[1994],df[1995]]
ax.bar(range(1, len(HH)+1), np.array(df['MM']),width=.95, color='yellow', align='center')
#plt.bar(HH,np.array(df['MM']),width=.95,align='center')
#ax2 = ax.twinx()
ax.boxplot(xx,whis=0.05)
ax.set_xticklabels(HH, rotation='vertical')
